    ...
    <div class="row">
        <div class="col-lg-12 order-lg-1">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Tambah Akun Mahasiswa</h6>
                </div>

                <div class="card-body">
                    <form action="{{ route('manajemen_akun.mahasiswa.store') }}" method="POST">
                        @csrf
        ...
        <div class="col-lg-12 order-lg-1">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Daftar Akun Mahasiswa</h6>
                </div>
                        ...
                        <tbody>
                            @foreach ($data as $mahasiswa)
                                <tr>
                                    ...
                                    <td>{{ $mahasiswa->name }} {{ $mahasiswa->last_name }}</td>
                                    <td>{{$mahasiswa->email}}</td>
                                    <td>{{$mahasiswa->salt}}</td>
                                    <td>{{$mahasiswa->nama_mahasiswa}}</td>
                                    {{-- <td>
                                        <a href="{{ route('manajemen_akun.mahasiswa.detail', $mahasiswa->id) }}" class="btn btn-info btn-sm">Mata Kuliah</a>
                                    </td> --}}
                                </tr>
                            @endforeach
                        </tbody>
